...
#     temporary variables to preserve quoting and avoid bad expansion.
#   * Put the arguments into a shell array; this lets some shells (e.g. bash/dash)
#     better handle word splitting and quoted arguments.
set -- \
